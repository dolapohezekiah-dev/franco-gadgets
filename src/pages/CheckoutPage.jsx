      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 space-y-3">
            <h2 className="text-white font-display text-xl tracking-wider mb-4">YOUR ITEMS</h2>
            {cartItems.map((item) => (
              <div key={item.key} className="bg-brand-card border border-brand-border rounded-2xl p-4 flex gap-4">
                <img
                ...
                <div className="flex-1">
                  <h3 className="text-brand-light font-body font-semibold">{item.product.name}</h3>
                  {item.variant && (
                    <p className="text-brand-muted text-xs font-mono">{item.variant.label}</p>
                  )}
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-brand-muted text-sm font-mono">×{item.quantity}</span>
                      <button
            ...
            <div className="bg-brand-card border border-brand-border rounded-2xl p-5 mt-4">
              <h3 className="text-white font-display text-lg tracking-wider mb-4">YOUR INFO (Optional)</h3>
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-brand-dark border border-brand-border rounded-xl px-4 py-3 text-brand-light placeholder-brand-muted font-body text-sm focus:outline-none focus:border-brand-cyan transition-colors resize-none"
                />
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-brand-card border border-brand-border rounded-2xl p-6 sticky top-24">
              <h2 className="text-white font-display text-xl tracking-wider mb-6">ORDER SUMMARY</h2>

              <div className="space-y-3 mb-6">
                <div className="flex justify-between text-brand-muted font-body text-sm">
              ...
              <button
                ...
                className="w-full bg-emerald-500 hover:bg-emerald-400 text-white py-4 rounded-xl font-display text-xl tracking-wider transition-all flex items-center justify-center gap-3 shadow-lg shadow-emerald-500/30 mb-3"
              >
              ...
              <button
                ...
                className="w-full border border-brand-border text-brand-muted py-3 rounded-xl font-body text-sm hover:border-brand-cyan/50 hover:text-brand-light transition-all flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <p className="text-brand-muted text-xs font-body text-center mt-4 leading-relaxed">
